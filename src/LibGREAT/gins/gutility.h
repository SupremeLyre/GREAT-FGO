...
struct IMUState
{
    ...
    IMUState() : id(0), time(0), orientation(Eigen::Quaterniond::Identity()), position(Eigen::Vector3d::Zero())
    {
    }
};
 ...
 */
// class LibGREAT_LIBRARY_EXPORT t_gglv;

////LibSet_LIBRARY_EXPORT extern const t_gglv glv;
//

// LibGREAT_LIBRARY_EXPORT extern const t_gglv glv;
class t_gglv
{
  public:
    // inline t_gglv(double Re = 6378137.0, double f = (1.0 / 298.257), double wie0 = 7.2921151467e-5, double g0
    // = 9.7803267714);

    // double Re, f, wie, g0, mg, ug;	///< earth ellipsoid parameters
